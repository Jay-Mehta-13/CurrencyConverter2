...
//        System.out.println(Curr1 + " " + Curr2 + "______________________________________---------------------------------");
    }
    ...
    class RateThread extends Thread{
        ...
        public void run() {
            ...
            try {
                ...
                rate = (double) rateJO.get(conversion);

                result = rate * Double.parseDouble(String.valueOf(Number));
